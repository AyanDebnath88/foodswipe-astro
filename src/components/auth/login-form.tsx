...
// Ported from the reference Next.js project's src/components/auth/login-form.tsx.
// See signup-form.tsx for the same set of deviations (real Supabase Auth
// calls instead of fake server actions; window.location instead of
